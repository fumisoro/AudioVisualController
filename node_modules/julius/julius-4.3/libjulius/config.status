...
${ac_dA}JULIUS_VERSION${ac_dB}JULIUS_VERSION${ac_dC}"4.3"${ac_dD}
${ac_uA}JULIUS_VERSION${ac_uB}JULIUS_VERSION${ac_uC}"4.3"${ac_uD}
${ac_eA}JULIUS_VERSION${ac_eB}JULIUS_VERSION${ac_eC}"4.3"${ac_eD}
CEOF
  sed -f conftest.frag conftest.in > conftest.out
  rm -f conftest.in
  mv conftest.out conftest.in
...
${ac_dA}JULIUS_HOSTINFO${ac_dB}JULIUS_HOSTINFO${ac_dC}"armv7l-unknown-linux-gnueabi"${ac_dD}
${ac_uA}JULIUS_HOSTINFO${ac_uB}JULIUS_HOSTINFO${ac_uC}"armv7l-unknown-linux-gnueabi"${ac_uD}
${ac_eA}JULIUS_HOSTINFO${ac_eB}JULIUS_HOSTINFO${ac_eC}"armv7l-unknown-linux-gnueabi"${ac_eD}
